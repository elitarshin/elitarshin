...
return (
    <div className='flex flex-col items-center mt-24'>
      ...
      <div className='w-full border-2 p-12 flex justify-center flex-wrap gap-28'>
        <div className='w-2/5 flex flex-col gap-5 text-center border-2 p-4'>
            <img src={bgstory} alt="" />
        ...
        <div className='flex flex-col flex-wrap justify-around gap-10 text-center'>
            <div className='w-72 h-40 flex items-center p-2 border-2 font-bold text-xl '>{t("apartments")}</div>
            <div className='w-72 h-40 flex items-center p-2 border-2 font-bold text-xl '>{t("twnbuilds")}</div>
            <div className='w-72 h-40 flex items-center p-2 border-2 font-bold text-xl flex justify-center'>{t("earthworks")}</div>
        </div>
      </div>
