...
const isAutoInsertedRule = element => element.type === 'rule' && element.parent && haveSameLocation(element, element.parent);
...
const interleave = (strings /*: Array<*> */, interpolations /*: Array<*> */) => interpolations.reduce((array, interp, i) => array.concat([interp], strings[i + 1]), [strings[0]]);
