import { transformExpressionWithStyles, getStyledOptions, addImport, createTransformerMacro } from './utils';
const getReferencedSpecifier = (path, specifierName) => {
  const specifiers = path.get('specifiers');
  return specifierName === 'default' ? specifiers.find(p => p.isImportDefaultSpecifier()) : specifiers.find(p => p.node.local.name === specifierName);
};
